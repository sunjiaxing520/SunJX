...
| `N26` | P6.5 调度 | `workflow_templates/runs/run_steps` 持久化；全局单流程；分析到作词默认冷却 15 秒；步骤保存 task_id/output_id，失败即停 | P6.5 维护说明、决策记录 |
